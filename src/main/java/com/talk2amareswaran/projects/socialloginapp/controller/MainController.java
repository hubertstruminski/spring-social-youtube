...
/*
	...
	public void processAccessToken(HttpServletRequest request) {
	...
	public String authorize(@RequestParam("code") String authorizationCode,Model model) {
		...
		AccessGrant accessGrant = connectionFactory.getOAuthOperations().exchangeForAccess(authorizationCode, "https://localhost:4443facebook/callback", null); // not that the application was deployed at "http://localhost:8080/testApp"
